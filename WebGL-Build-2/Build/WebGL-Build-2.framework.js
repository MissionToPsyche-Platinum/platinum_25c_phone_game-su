...
var ASM_CONSTS = {
  3966756: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3966811: ($0) => { performance.now = function() { return $0; }; },  
 3966859: ($0) => { performance.now = function() { return $0; }; },  
 3966907: () => { performance.now = Module['emscripten_get_now_backup']; }
};
